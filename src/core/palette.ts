...
import { PALETTE_COLORS, RGBColor } from './types.js';

export const SWEETIE_16: RGBColor[] = [
...
export const GAMEBOY_16: RGBColor[] = [
...
export const CYBERPUNK_16: RGBColor[] = [
